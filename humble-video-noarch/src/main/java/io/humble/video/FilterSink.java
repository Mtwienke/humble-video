...
public class FilterSink extends FilterEndPoint {
   ...
   * Internal Only.
   */
  protected FilterSink(long cPtr, boolean cMemoryOwn) {
    super(VideoJNI.FilterSink_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  {
    super(VideoJNI.FilterSink_SWIGUpcast(cPtr),
     cMemoryOwn, ref);
    swigCPtr = cPtr;
  }
   ...
   */
  protected static long getCPtr(FilterSink obj) {
   ...
   */
  @Override
  public FilterSink copyReference() {
    if (swigCPtr == 0)
      return null;
    else
      return new FilterSink(swigCPtr, swigCMemOwn, getJavaRefCount());
  }
  ...
  public boolean equals(Object obj) {
    boolean equal = false;
    if (obj instanceof FilterSink)
      equal = (((FilterSink)obj).swigCPtr == this.swigCPtr);
    return equal;
  }
